...
insert into classroom values('not selected',true);
...
parent_name varchar(50) DEFAULT 'not selected',year_of_joining integer(10),
...
select*from user;
/*select * from user where roll='student';
delete from user where email='suneel18@gmail.com';
update user set status ='not approved'  where User_ID=1;
update user set is_active =0  where User_ID=1;
update user set Password ="John0987"  where Email="John@gmail.com";*/
drop table user;
